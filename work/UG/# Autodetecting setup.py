...
from globalFunction import Checker
from globalFunction import convertNumberToDate
...
commonPath = Variable.get("common_path", deserialize_json=True)

yesterday = datetime.today() - timedelta(days=1)
run_date = yesterday.strftime('%Y%m%d')
D_2 = datetime.today() - timedelta(days=2)
run_dateD_2 = D_2.strftime('%Y%m%d')
day3before = datetime.today() - timedelta(days=3)
run_dateD_3 = day3before.strftime('%Y%m%d')

day6before = datetime.today() - timedelta(days=3)
run_dateD_6 = day6before.strftime('%Y%m%d')
...
SUMMARY_CLEANER = BashOperator(
    task_id='SUMMARY_CLEANER' ,
    depends_on_past=False,
    bash_command='python3 /mnt/beegfs_bsl2/Tools/script/Summary_cleaner.py ',
    dag=dag,
